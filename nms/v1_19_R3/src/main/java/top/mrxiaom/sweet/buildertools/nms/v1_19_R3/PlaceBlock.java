package top.mrxiaom.sweet.buildertools.nms.v1_19_R3;
...
public class PlaceBlock implements IPlaceBlock {
    ...
    public boolean place(
        ...
        if (type instanceof ItemBlock blockItem) {
            ...
            ItemActionContext useOnContext = new ItemActionContext(nmsPlayer.H, nmsPlayer, EnumHand.a, item, blockHitResult);
