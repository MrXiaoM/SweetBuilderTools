package top.mrxiaom.sweet.buildertools.nms.v1_20_R1;
...
public class PlaceBlock implements IPlaceBlock {
    ...
    public boolean place(
        ...
        if (type instanceof ItemBlock blockItem) {
            ...
            ItemActionContext useOnContext = new ItemActionContext(nmsPlayer.dI(), nmsPlayer, EnumHand.a, item, blockHitResult);
