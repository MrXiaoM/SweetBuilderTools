package top.mrxiaom.sweet.buildertools.nms.v1_21_R6;
...
public class PlaceBlock implements IPlaceBlock {
    ...
    public boolean place(
        ...
        if (type instanceof ItemBlock blockItem) {
            ...
            ItemActionContext useOnContext = new ItemActionContext(nmsPlayer.an(), nmsPlayer, EnumHand.a, item, blockHitResult);
