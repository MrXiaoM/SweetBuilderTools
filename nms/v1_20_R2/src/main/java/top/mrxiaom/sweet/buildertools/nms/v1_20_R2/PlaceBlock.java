package top.mrxiaom.sweet.buildertools.nms.v1_20_R2;
...
public class PlaceBlock implements IPlaceBlock {
    ...
    public boolean place(
        ...
        if (type instanceof ItemBlock blockItem) {
            ...
            ItemActionContext useOnContext = new ItemActionContext(nmsPlayer.dL(), nmsPlayer, EnumHand.a, item, blockHitResult);
